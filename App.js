  ...
  export default (props) => (
    <div className="App">
        <div>
            ...
            <SerieTop7 title = "06. Mare of the Easttown" descricao = "Essa minissérie conta a história de uma detetive de uma cidadezinha americana da Pensilvânia que investiga um assassinato e luta para manter a vida dela nos eixos"/>
          </div>
    </div>
)
